...
void greetings(){
    ...
    if (time-> tm_hour < 12){
        cout<< "Good Morning Master Abhishek"<<endl;
        string phrase = "Good Morning Master Abhishek";
        ...
        cout<< "Good Afternoon Master Abhishek"<<endl;
        string phrase = "Good Afternoon Master Abhishek";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
        ...
        cout<< "Good Evening Master Abhishek"<<endl;
        string phrase = "Good Evening Master Abhishek";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
    }
...
int main()
{
    ...
    {
        cout<<"******************************************************"<<endl;
        cout<<"| ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER Abhishek|"<<endl;
        cout<<"******************************************************"<<endl<<endl;
        string phrase = "ENTER THE PASSWORD TO CONFIRM YOU ARE MASTER Abhishek";
        string command = "espeak \"" + phrase + "\"";
        const char *charCommand = command.c_str();
        system(charCommand);
        ...
        if(password=="0010")
        {
            ...
            do{
                ...
                {
                    cout<<"Hello Master Abhishek....."<<endl;
                    string phrase = "Hello Master Abhishek";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                {
                    cout<<"I'm a personal assistant created by Master Abhishek !!!"<<endl;
                    string phrase = "I'm a personal assistant created by Master Abhishek !!!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                }
                ...
                else if(command=="play music")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                     ShellExecute(NULL,"open","Bella_Ciao.mp3",NULL, NULL, SW_NORMAL);
                ...
                else if(command=="open video")
                {
                    ...
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    ShellExecute(NULL,"open","D:\\projects\\personal assistant\\Bella_Ciao_video.mp4",NULL, NULL, SW_NORMAL);

                }

                else if(command=="bye" || command=="exit")
                {
                    cout<<"Good Bye Master Abhishek, see you soon!"<<endl;
                    string phrase = "Good Bye Master Abhishek, see you soon!";
                    string command = "espeak \"" + phrase + "\"";
                    const char *charCommand = command.c_str();
                    system(charCommand);
                    exit(0);
